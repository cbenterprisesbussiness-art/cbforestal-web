  ...
  build: {
    rollupOptions: {
      input: {
        ...
        castelldefels: resolve(__dirname, 'servicios-forestales-castelldefels/index.html'),
        sitges: resolve(__dirname, 'servicios-forestales-sitges/index.html'),
        granollers: resolve(__dirname, 'servicios-forestales-granollers/index.html'),
      },
    },
  },
});
